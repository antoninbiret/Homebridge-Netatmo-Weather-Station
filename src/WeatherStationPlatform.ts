...
import { WeatherStationPlatformAccessory } from "./WeatherStationPlatformAccessory";
...
export class WeatherStationPlatform implements DynamicPlatformPlugin {
  ...
  discoverDevices() {
    ...
    const exampleDevices = [
      {
        exampleUniqueId: "temp-sensor-id-unique",
        exampleDisplayName: "Device name",
      },
      // {
    ...
    for (const device of exampleDevices) {
      ...
      if (existingAccessory) {
        ...
        new WeatherStationPlatformAccessory(
          this,
          existingAccessory,
          this.netatmoAPI
        );
        ...
        // this is imported from `platformAccessory.ts`
        new WeatherStationPlatformAccessory(this, accessory, this.netatmoAPI);
